...
$FLATC --go -o "$OUTPUT_DIR/" "$NET_NAME"
$FLATC --go -o "$OUTPUT_DIR/" "$PROGRAM_NAME"
$FLATC --go -o "$OUTPUT_DIR/go" "$SCHEMA_NAME" --go-module-name "github.com/Opticode-Project/go-compiler"
